...
import com.chaoxing.camera.util.CheckPermission;
import com.chaoxing.camera.util.LogUtil;

import static com.chaoxing.camera.JCameraView.BUTTON_STATE_BOTH;
import static com.chaoxing.camera.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.chaoxing.camera.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private int progress_color = 0xFF0099FF;            //进度条颜色
    ...
    private int getButtonSize(Context context){
...
//                if ((button_state == BUTTON_STATE_ONLY_RECORDER || button_state == BUTTON_STATE_BOTH))
    ...
    private class LongPressRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (button_state == BUTTON_STATE_BOTH || button_state == BUTTON_STATE_ONLY_RECORDER) {
                //没有录制权限
